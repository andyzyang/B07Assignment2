...
/**
 * Thrown when trying to pop from an empty directory stack
 */
public class EmptyDirectoryStackException extends ShellException {

  public EmptyDirectoryStackException() {
    // give appropriate message
    super("directory stack is empty");
  }
}
